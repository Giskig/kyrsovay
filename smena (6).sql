...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 07 2025 г., 18:24
...
--
ALTER TABLE `changing`
  MODIFY `id_changing` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `news`
  MODIFY `id_nwes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
